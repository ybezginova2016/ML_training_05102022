...
# Преобразование, обратное сжатию, — это растяжение.
# Матрица, обратная сжатию вектора в 2 раза, будет в 2 раза
# его растягивать.
print()
import numpy as np
...
print(b)
print("Матрица, обратная обратной:")
print(c)
print()
...
b = np.linalg.inv(a)
c = np.linalg.inv(a.T) # Правая часть
print("Транспонированная обратная матрица:")
print(b.T) # Левая часть
print("Обратная транспонированная матрица:")
print(c)
print()
# Умножение обратной матрицы на скаляр
